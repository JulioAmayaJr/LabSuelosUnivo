                ...
                <form>
                            <div class="form-row">
                                <div class="form-group col-sm-12">
                                    <img id="imgFoto" src="img/<?=$user["image"]?>" class="rounded mx-auto d-block" style="width: 200px; height: 200px;">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-sm-12">
            ...
            <form>
                <div class="form-row">
                    <div class="form-group col-sm-12 position-relative">
                        ...
                        <input readonly type="password" class="form-control form-control-sm input-validar" id="txtClaveActual" value="<?=$pass?>">
                        <i class="fas fa-eye toggle-password" style="position: absolute; right: 10px; top: 40px; cursor: pointer;"></i>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-sm-12">
